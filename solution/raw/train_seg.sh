...
python tools/run_net.py \
  ...
  DATA.PATH_TO_DATA_DIR /home/haoren/repo/slowfast/data/raw/anno_seg_pure_action_add0315_balance_pos_neg_balance_scenario_full/ \
  DATA.PATH_PREFIX /home/haoren/repo/slowfast/data/raw/ \
  NUM_GPUS 1 \
  TRAIN.BATCH_SIZE 4 \
  TEST.ENABLE False \
  DEMO.ENABLE False \
  OUTPUT_DIR ./checkpoints/slowfast_seg_channel64_beta4_class2_pure_action_add0315_balance_pos_neg_balance_scenario_full_equal_lr0p0001/ \